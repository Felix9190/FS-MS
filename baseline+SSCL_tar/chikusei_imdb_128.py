...
# imdb = getDataAndLabels(train_data_file, train_label_file, patch_length=4) # 9*9
# with open('../../datasets/Chikusei_imdb_128.pickle', 'wb') as handle:
#     pickle.dump(imdb, handle, protocol=4)

imdb = getDataAndLabels(train_data_file, train_label_file, patch_length=3) # 7*7
with open('../../datasets/Chikusei_imdb_128_7_7.pickle', 'wb') as handle:
    pickle.dump(imdb, handle, protocol=4)
